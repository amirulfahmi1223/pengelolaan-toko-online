...
$banyakDataPerHal = 5;
$banyakData = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tb_category"));
...
if ((isset($_POST['Bcari'])) and $_POST['Pkeyword'] <> "") {
  ...
  $select = mysqli_query($conn, "SELECT * FROM tb_category WHERE 
  category_name LIKE '%$keyword%'
  LIMIT $dataAwal,$banyakDataPerHal");
} else {
  $select = mysqli_query($conn, "SELECT * FROM tb_category LIMIT $dataAwal,$banyakDataPerHal");
}
?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="tambah-kategori.php" class="btn btn-primary"><i class="fa-solid fa-cart-plus mr-1"></i>Tambah Data</a>
              <!-- Topbar Search -->
                    ...
                    ?>
                      ...
                      <?php foreach ($select as $rows) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="edit-kategori.php?category_id=<?= $rows['category_id'] ?>" class="btn btn-success text-white rounded"><i class="fa-solid fa-pen-to-square"></i></a>
                          </td>
                          <td><a href="hapus-categori.php?category_id=<?= $rows['category_id'] ?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-danger text-white rounded"><i class="fa-solid fa-trash-can"></i></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    <?php else : ?>
