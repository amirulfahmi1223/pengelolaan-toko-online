                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      <label for="inputAddress">Password1</label>
                      <input type="password" placeholder="Password Baru" maxlength="35" class="form-control mt-2" id="validationCustom01" name="pass1" required>
                    </div>
                    <div class="form-group mt-2">
                      <label for="">Password2</label>
                      <input type="password" placeholder="Konfirmasi Password Baru" maxlength="100" class="form-control mt-2" id="validationCustom02" name="pass2" required>
                    </div>
