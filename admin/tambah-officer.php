...
if (isset($_POST['submit'])) {
  if (register($_POST) > 0) {
    echo '<script>alert("Tambah Data Office Berhasil")</script>';
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">Tambah Officer</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="35" class="form-control mt-2" id="validationCustom01" name="nama" placeholder="Masukkan Nama" required>
                    ...
                    <div class="form-group mt-3">
                      ...
                      <input type="email" maxlength="100" class="form-control mt-2" id="validationCustom02" name="email" placeholder="Masukkan Email" required>
                      <small id="passwordHelpInline" class="text-muted">
                    ...
                    <div class="form-group mt-3">
                      ...
                      <input type="password" maxlength="100" class="form-control mt-2" id="validationCustom03" name="pass" placeholder="Masukkan Password" required>
                      <small id="passwordHelpInline" class="text-muted">
                        Must be 1-100 characters long.
                      </small>
                      <div class="valid-feedback">
                      ...
                      <div class="invalid-feedback">
                        Please choose a tempat tanggal lahir.
                      </div>
                    </div>
                    <div class="form-group mt-3">
                      <label for="">Level</label>
                      <select name="level" id="" class="form-control mt-2" required>
                    ...
                    <button type="submit" class="btn btn-info mt-3 mb-1 float-right text-white" name="submit">Tambah</button>
                  </form>
                </div>
              </div>
            </div>
