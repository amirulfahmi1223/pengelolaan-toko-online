...
$k = query("SELECT * FROM tb_category WHERE category_id = $id")[0];
if (isset($_POST['ubah'])) {
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <!-- Dropdown - Messages -->
              <div method="POST" class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      <input type="hidden" name="category_id" value="<?= $k['category_id']; ?>">
                      <input type="text" name="kategori" value="<?= $k['category_name'] ?>" maxlength="50" class="form-control mt-2" id="validationCustom01" required>
                    ...
                    <button type="submit" name="ubah" class="btn btn-info mt-1 mb-1 float-right text-white" name="submit">Edit</button>
                  </form>
                </div>
              </div>
            </div>
