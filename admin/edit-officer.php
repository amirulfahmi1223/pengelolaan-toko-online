...
$a = query("SELECT * FROM tb_admin WHERE id_admin = $id")[0];
if (isset($_POST['ubah'])) {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">Edit Officer</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="35" class="form-control mt-2" id="validationCustom01" name="nama" value="<?= $a['admin_name']; ?>" required>
                    </div>
                    <div class="form-group mt-2">
                      <label for="">Email</label>
                      <input type="email" maxlength="100" class="form-control mt-2" id="validationCustom02" name="email" value="<?= $a['email']; ?>" required>
                    </div>
                    <div class="form-group mt-3">
                      <label for="">Password</label>
                      <input type="text" maxlength="100" class="form-control mt-2" id="validationCustom03" name="pass" value="<?= $a['password']; ?>" required>
                    </div>
                    <div class="form-group mt-3">
                      <label for="">Level</label>
                      <input type="text" value="<?= $a['level']; ?>"="100" class="form-control mt-2" id="validationCustom03" readonly>
                    </div>
                    <button type="submit" class="btn btn-info mt-3 mb-1 float-right text-white" name="ubah">Ubah</button>
                  </form>
                </div>
              </div>
            </div>
