                ...
                <div class="card-body">
                  <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mt-4">
                      <input type="text" name="nama" maxlength="100" class="form-control mt-2" id="validationCustom02" placeholder="Masukkan Nama Produk" required>
                    </div>
                    <div class="form-group mt-4">
                      <input type="number" name="harga" maxlength="140" class="form-control mt-2" id="validationCustom03" placeholder="Masukkan Harga" required>
                    </div>
                    <div class="form-group mt-4">
                      <input type="text" name="stok" maxlength="9999" class="form-control mt-2" id="validationCustom04" placeholder="Masukkan Jumlah Stok" required>
                    </div>
                    <div class="form-group mt-4">
                      <input type="file" class="mt-2" id="validationCustom04" name="gambar" required>
                    </div>
                    <div class="form-group mt-4">
