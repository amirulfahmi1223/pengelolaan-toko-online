...
$p = query("SELECT * FROM tb_product WHERE product_id = $id")[0];
if (isset($_POST['ubah'])) {
                ...
                <div class="card-body">
                  <form action="" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mt-4">
                      <input type="text" name="produk" maxlength="14" class="form-control mt-2" id="validationCustom02" value="<?= $p['product_name']; ?>" required>
                    </div>
                    <div class="form-group mt-4">
                      <input type="number" name="harga" maxlength="140" class="form-control mt-2" id="validationCustom03" value="<?= $p['product_price']; ?>" required>
                    </div>
                    <div class="form-group mt-4">
                      <input type="text" name="stok" maxlength="70" class="form-control mt-2" id="validationCustom04" value="<?= $p['product_pcs']; ?>" required>
                    </div>
                    <img src="image/<?php echo $p['product_image']; ?>" width=" 50px" height="50px" class="ml-3">
                    <div class=" form-group mt-2">
                      <input type="file" maxlength="70" id="validationCustom04" name="gambar">
                    </div>
                    <input type="hidden" name="product_id" value="<?php echo $p['product_id']; ?>">
                    <input type="hidden" name="gambarLama" value="<?php echo $p['product_image']; ?>">
                    <div class="form-group mt-4">
