    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-3 text-gray-800">Tambah Kategori</h1>
          <!--Bagian nama lengkap-->
          <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="card-body">
                  <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="form-group">
                      <input type="text" maxlength="50" class="form-control mt-2" id="validationCustom01" name="kategori" placeholder="Masukkan Nama Kategori" required>
